...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.9\linewidth]{../results/menace_results.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.9\linewidth]{../results/binary_bandit_results.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.9\linewidth]{../results/bandit_means.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.9\linewidth]{../results/non_stationary_comparison.png}}
