...
\begin{itemize}
    ...
    \end{itemize}
\end{itemize}
We implemented this logic in Python, training against a Random Agent.
...
\end{cases}
\end{equation}
The value estimates $Q_t(a)$ are updated using the sample average method.
...
\end{equation}
This non-stationarity makes sample averages ineffective as they weigh old rewards equally to new ones. We compare two agents:
\begin{enumerate}
