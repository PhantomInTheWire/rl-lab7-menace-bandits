...
\begin{itemize}
    ...
    \end{itemize}
\end{itemize}
We implemented this logic in Python, training against a Random Agent. Source code: \texttt{ex7\_1.py}\footnote{\url{https://github.com/PhantomInTheWire/rl-lab7-menace-bandits/blob/master/ex7_1.py}}
...
\end{cases}
\end{equation}
The value estimates $Q_t(a)$ are updated using the sample average method. Source code: \texttt{ex7\_2.py}\footnote{\url{https://github.com/PhantomInTheWire/rl-lab7-menace-bandits/blob/master/ex7_2.py}}
...
\end{equation}
This non-stationarity makes sample averages ineffective as they weigh old rewards equally to new ones. The bandit environment is implemented in \texttt{ex7\_3.py}\footnote{\url{https://github.com/PhantomInTheWire/rl-lab7-menace-bandits/blob/master/ex7_3.py}}. We compare two agents:
\begin{enumerate}
...
\end{enumerate}
The comparison implementation is in \texttt{ex7\_4.py}\footnote{\url{https://github.com/PhantomInTheWire/rl-lab7-menace-bandits/blob/master/ex7_4.py}}.
